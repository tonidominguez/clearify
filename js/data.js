$(document).ready(function() {
   var sparklineLogin = function() { 
        $("#sparkline1").sparkline([15,7,9,4,2,4,6,13,11,7,10], {
        type: 'bar',
        height: '45',
        barWidth: 6,
        barSpacing: 5,
        ...
        $('#sparkline2').sparkline([10, 40, 10], {
            type: 'pie',
            width: '50',
            height: '45',
            resize: true,
            sliceColors: ['#179CDD', '#3AA520', '#D22469']
        });

    
        $('#sparkline3').sparkline([5, 6, 2, 9, 4, 7, 10, 12, 4, 8, 10, 3, 7], {
            type: 'bar',
            height: '164',
            barWidth: '7',
            resize: true,
        ...
        $("#sparkline3a").sparkline([1,1,0,1,-1,-1,1,-1,0,0,1,1], {
            type: 'tristate',
            barWidth: 5,
            barSpacing: 2,
            lineHeight: '70%'
